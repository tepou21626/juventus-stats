...
(function (d3) {
  ...
  // first viz
  d3.csv(
    new URL('./assets/data/data_offensive.csv', import.meta.url),
    d3.autoType
  ).then(function (data) {
  ...
  // second viz
  d3.csv(
    new URL('./assets/data/data_defensive.csv', import.meta.url),
    d3.autoType
  ).then(function (data) {
  ...
  d3.csv(new URL('./assets/data/totalSalaries2019.csv', import.meta.url))
    .then((data) => {
  ...
  d3.csv(new URL('./assets/data/totalSalaries2020.csv', import.meta.url))
    .then((data) => {
  ...
  d3.csv(new URL('./assets/data/totalSalaries2021.csv', import.meta.url))
    .then((data) => {
